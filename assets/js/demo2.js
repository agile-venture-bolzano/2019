import initPageTransitions from "./initPageTransitions.js";
...
class Demo2 {
  ...
  initDemo() {
    ...
    const swiperButtonPrev = document.querySelector(".mobile-swiper-nav.next");
    const swiperButtonNext = document.querySelector(".mobile-swiper-nav.");
